...
To install **CONVERGE CFD**, you must download the software package from the official portal, set up the licensing manager, and configure environment variables.
...
Installing CONVERGE with Your Choice of OS
------------------------------------------
.. toctree::
   :maxdepth: 1
...
.. note::
   There is no official native Mac version of the CONVERGE CFD suite.
